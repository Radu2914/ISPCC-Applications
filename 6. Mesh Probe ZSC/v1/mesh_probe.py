...
def main():
    ...
    if len(args.loaded) > 4:
        print(f'  [WARN] More than 4 load zones specified ({len(args.loaded)}). '
              f'Expected 1–4 focus zones.')
